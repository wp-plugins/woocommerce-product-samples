...
Sell or Give Samples of WooCommerce Products.
...
What more, the sample products are just products, so you can apply all the shipping and inventory rules. And this even works for digital goods.

There are also options to exclude sample products from shop and category pages, position, style and change add to cart button text.
